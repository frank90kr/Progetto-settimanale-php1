...
<html lang="en">
  ...
  <div class="card-body">
    <h5 class="card-title text-primary">Libreria in PHP</h5>
    <a href="./aggiungi.php" class="btn btn-success mt-2"><i class="bi bi-plus-square-dotted me-2"></i> Aggiungi libro</a>
  </div>
  <div class="card-footer text-body-secondary">
    &copy; 2024 Libreria PHP
  </div>
</div>
