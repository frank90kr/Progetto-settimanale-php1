...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($anno_pubblicazione > 2024) {
        $errors[] = "L'anno di pubblicazione deve essere inferiore o uguale a 2024.";
    }
    // Validazione titolo vuoto e caratteri titolo
    if (empty($_POST["titolo"])) {
        $errors[] = "Il titolo del libro è obbligatorio.";
    } elseif (!preg_match("/^[a-zA-Z0-9\s\-.,'()!]+$/", $titolo)) {
        $errors[] = "Il titolo del libro contiene caratteri non validi.";
    }
...
<div class="container">
    <h1 class="text-center mt-4">Aggiungi libro</h1>
    <p class="text-center text-secondary py-1">Compila tutti i campi e clicca invia</p>
